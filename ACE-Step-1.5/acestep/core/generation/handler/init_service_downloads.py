...
class InitServiceDownloadsMixin:
    ...
    # 支持的 XL DiT 模型列表
    XL_DIT_MODELS = ["acestep-v15-xl-turbo", "acestep-v15-xl-base", "acestep-v15-xl-sft"]
    ...
    def _ensure_models_present(
        ...
        *,
        ...
        # 如果使用的是 XL DiT 模型，跳过默认的 acestep-v15-turbo 检查
        is_xl_model = config_path in self.XL_DIT_MODELS
        
        if not is_xl_model and not check_main_model_exists(checkpoint_path):
